...
GDAL_CMAKE_OPTS=" -DGDAL_BUILD_OPTIONAL_DRIVERS=OFF \ 
        ...
        -DGDAL_ENABLE_DRIVER_AIRSAR_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_ARG=OFF \ 
        -DGDAL_ENABLE_DRIVER_ARG_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_BLX=OFF \ 
        -DGDAL_ENABLE_DRIVER_BLX_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_BMP=OFF \ 
        -DGDAL_ENABLE_DRIVER_BMP_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_BSB=OFF \ 
        -DGDAL_ENABLE_DRIVER_BSB_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_CALS=OFF \ 
        -DGDAL_ENABLE_DRIVER_CALS_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_CEOS=OFF \ 
        -DGDAL_ENABLE_DRIVER_CEOS_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_COASP=OFF \ 
        -DGDAL_ENABLE_DRIVER_COASP_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_COSAR=OFF \ 
        -DGDAL_ENABLE_DRIVER_COSAR_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_CTG=OFF \ 
        -DGDAL_ENABLE_DRIVER_CTG_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_DAAS=OFF \ 
        -DGDAL_ENABLE_DRIVER_DAAS_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_DIMAP=OFF \ 
        -DGDAL_ENABLE_DRIVER_DIMAP_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_DTED=OFF \ 
        -DGDAL_ENABLE_DRIVER_DTED_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_EEDA=OFF \ 
        -DGDAL_ENABLE_DRIVER_EEDA_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_ELAS=OFF \ 
        -DGDAL_ENABLE_DRIVER_ELAS_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_ENVISAT=OFF \ 
        -DGDAL_ENABLE_DRIVER_ENVISAT_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_ERS=OFF \ 
        -DGDAL_ENABLE_DRIVER_ERS_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_ESRIC=OFF \ 
        -DGDAL_ENABLE_DRIVER_ESRIC_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_EXR=OFF \ 
        -DGDAL_ENABLE_DRIVER_EXR_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_FIT=OFF \ 
        -DGDAL_ENABLE_DRIVER_FITS=OFF \ 
        -DGDAL_ENABLE_DRIVER_FITS_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_FIT_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_GFF=OFF \ 
        -DGDAL_ENABLE_DRIVER_GFF_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_GIF=OFF \ 
        -DGDAL_ENABLE_DRIVER_GRIB=OFF \ 
        -DGDAL_ENABLE_DRIVER_GRIB_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_GSG=OFF \ 
        -DGDAL_ENABLE_DRIVER_GTIFF=OFF \ 
        -DGDAL_ENABLE_DRIVER_GXF=OFF \ 
        -DGDAL_ENABLE_DRIVER_GXF_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_HDF5=OFF \ 
        -DGDAL_ENABLE_DRIVER_HDF5_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_HEIF=OFF \ 
        -DGDAL_ENABLE_DRIVER_HEIF_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_HF2=OFF \ 
        -DGDAL_ENABLE_DRIVER_HF2_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_HFA=OFF \ 
        -DGDAL_ENABLE_DRIVER_HTTP=OFF \ 
        -DGDAL_ENABLE_DRIVER_HTTP_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_IDRISI=ON \ 
        -DGDAL_ENABLE_DRIVER_ILWIS=OFF \ 
        -DGDAL_ENABLE_DRIVER_ILWIS_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_IRIS=OFF \ 
        -DGDAL_ENABLE_DRIVER_IRIS_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_JAXAPALSAR=OFF \ 
        -DGDAL_ENABLE_DRIVER_JAXAPALSAR_PLUGIN=OFF \ 
        -DGDAL_ENABLE_DRIVER_JDEM=OFF \ 
        -DGDAL_ENABLE_DRIVER_JDEM_PLUGIN=OFF \ 
